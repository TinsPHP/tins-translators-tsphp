        ...
        collection.addAll(Arrays.asList(new Object[][]{
                ...
                //direct recursive function
                {
                        ...
                        "namespace{\n"
                                ...
                                + "    int $a;\n"
                                + "\n"
                                + "    function (int | T) fac0<T>(T $n) where [T < float] {\n"
                                + "        return ($n > 0) ? $n * fac($n - 1) : 1;\n"
                                + "    }\n"
                                + "\n"
                                + "    function (float | int) fac1(float $n) {\n"
                                + "        return ($n > 0) ? $n * fac($n - 1) : 1;\n"
                                + "    }\n"
                                + "\n"
                                + "    function int fac2(int $n) {\n"
                                + "        return ($n > 0) ? $n * fac($n - 1) : 1;\n"
                                + "    }\n"
                                + "\n"
                                + "    function T fac3<T>({as T} $n) where [int < T < (float | int)] {\n"
                                + "        return ($n > 0) ? $n * fac($n - 1) : 1;\n"
                                + "    }\n"
                                + "\n"
                                + "    $a = fac2(6);\n"
                ...
                // is restricted to Ty <: (int|float), Ty <: array respectively.
                {
                        ...
                        "namespace{\n"
                                + "\n"
                                + "    function (float | T) foo0<T>(T $x, float $y) where [T < {as (float | int)}] {\n"
                                + "        return ($x > 0) ? bar1($x + $y, $y) : $x;\n"
                                + "    }\n"
                                + "\n"
                                + "    function (int | T) foo1<T>(T $x, int $y) where [T < {as int}] {\n"
                ...
                //erroneous one (bool x bool -> int) and a valid one (array x array -> array)
                {
                        ...
                        "namespace{\n"
                                ...
                                + "    int $i;\n"
                                + "\n"
                                + "    function (float | T) rec10<T>(T $x, float $y) where [T < {as (float | int)}] {\n"
                                + "        return ($x > 0) ? rec21($x + $y, $y) : $x;\n"
                                + "    }\n"
                                + "\n"
                                + "    function (int | T) rec11<T>(T $x, int $y) where [T < {as int}] {\n"
