        ...
        collection.addAll(Arrays.asList(new Object[][]{
                ...
                //direct recursive function
                {
                        ...
                        "namespace{\n"
                                ...
                                + "    int $a;\n"
                                + "\n"
                                + "    function V7 fac0<V7, T>(T $n) where [(int | T) < V7 < {as V8}, T < float] {\n"
                ...
                //indirect recursive function
                {
                        ...
                        "namespace{\n"
                                + "\n"
                                + "    function V8 foo0<V8, T>(T $x) where [(int | T) < V8, T < {as int}] {\n"
                                + "        if ($x > 0) {\n"
                                + "            return bar2($x - 1);\n"
                                + "        }\n"
                                + "        return $x;\n"
                                ...
                                + "    }\n"
                                + "\n"
                                + "    function V8 bar0<V8, T>(T $x) where [(int | T) < V8, T < {as int}] {\n"
                                + "        if ($x > 0) {\n"
                                + "            return foo2($x - 1);\n"
                                + "        }\n"
                                + "        return $x;\n"
                ...
                //erroneous one (bool x bool -> int) and a valid one (array x array -> array)
                {
                        ...
                        "namespace{"
                                ...
                                + "\n    int $i;"
                                + "\n"
                                + "\n    function V9 rec10<V9, T>(T $x, float $y) "
                                + "where [(float | T) < V9, T < {as (float | int)}] {"
