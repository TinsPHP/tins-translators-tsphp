        ...
        return Arrays.asList(new Object[][]{
                ...
                //TINS-479 local vars with multiple lower ref to params
                {
                        ...
                        "namespace{\n"
                                ...
                                + "    }\n"
                                + "\n"
                                + "    function (falseType | float) foo2({as (float | int)} $x, float $y) {\n"
                                + "        (falseType | float) $a;\n"
                                + "        $a = $x / $y;\n"
                                + "        return $a;\n"
                                + "    }\n"
                                + "\n"
                                + "    function (falseType | float | int) foo3"
                ...
                //TINS-479 local vars with multiple lower ref to params
                {
                        ...
                        "namespace{\n"
                                ...
                                + "    }\n"
                                + "\n"
                                + "    function (float | int) fooK2(float $x, {as (float | int)} $y) {\n"
                                + "        (float | int) $a;\n"
                                + "        $a = 1;\n"
                                + "        $a = $x + $y;\n"
                                + "        return $a;\n"
                                + "    }\n"
                                + "\n"
                                + "    function int fooK3(int $x, int $y) {\n"
                                + "        int $a;\n"
                                + "        $a = 1;\n"
                                + "        $a = $x + $y;\n"
                                + "        return $a;\n"
                                + "    }\n"
                                + "\n"
                                + "    function (float | int) fooK4({as (float | int)} $x, float $y) {\n"
                                + "        (float | int) $a;\n"
                                + "        $a = 1;\n"
                                + "        $a = $x + $y;\n"
                                + "        return $a;\n"
